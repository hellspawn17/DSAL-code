...
#handle collisions using chaining with / without replacement. Data: Set of
#(key, value)pairs, Keys are mapped to values, Keys must be comparable,
#Keys must be unique Standard Operations: Insert (key, value), Find(key), Delete(key)(python)
class HashFunction:
    def __init__(self):
